...
const donneesChoisies = meteo_31_2023_2024_extrait.filter(d => d.nom_poste === color);
```

Les températures minimale et maximale pour la station ${color} à la date du ${dateString} sont ${objetTrouve.temp_min}°C et ${objetTrouve.temp_max}°C.
